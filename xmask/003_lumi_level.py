...
collider = xt.Multiline.from_json("xsuite_lines/collider_02_tuned_bb_off.json")
...
xlhc.luminosity_leveling(
    collider, config_lumi_leveling=config_lumi_leveling, config_beambeam=config_beambeam
)
...
collider.to_json("xsuite_lines/collider_03_tuned_and_leveled_bb_off.json")
