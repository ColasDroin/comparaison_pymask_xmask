...
collider = xt.Multiline.from_json("xsuite_lines/collider_03_tuned_and_leveled_bb_off.json")
...
collider.to_json("xsuite_lines/collider_04_tuned_and_leveled_bb_on.json")
